	...
	<div class="page-wrapper">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Notes Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">All Notes List</li>
							</ol>
						</div>
					</div>
					<div class="row">
	 ...
	 <td>{{$item->Name}}</td>
           ...
           <td>{{$item->Date}}</td>
																		...
																		<td align="center">
																			<a href="{{ url('Notes_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<a href="{{ url('TrashingNote/'.$item->id) }}"
