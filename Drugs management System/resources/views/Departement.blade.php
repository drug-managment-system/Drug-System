				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Departement Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Departement</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">All Departement List</li>
							</ol>
						</div>
					</div>
					<div class="row">
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href='AddDepartement' id="addRow"
																		class="btn btn-info">
         ...
         <th>DepartementName</th>
																...
																@foreach($Departement as $item)
                                                                 ...
                                                                 <td>{{$item->DepartementName}}</td>
																		...
																		<td align="center">
																			<a href="{{ url('Dep_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
														 
	             	  
																			<a href="{{ url('TrashingDepartement/'.$item->id) }}"
