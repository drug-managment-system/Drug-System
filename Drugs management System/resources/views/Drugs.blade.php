	...
	<div class="page-wrapper">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Drugs Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">All Drugs List</li>
							</ol>
						</div>
					</div>
					<div class="row">
        ...
        <th>AddCompany_ID</th>
           ...
           <td>{{$item->AddCompany_ID}}</td>
																		...
																		<td align="center">
																			<a href="{{ url('Drugs_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<a href="{{ url('TrashingDrug/'.$item->id) }}"
