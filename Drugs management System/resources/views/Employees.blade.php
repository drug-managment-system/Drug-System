	...
	<div class="page-wrapper">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Employees Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">All Employees List</li>
							</ol>
						</div>
					</div>
					<div class="row">
	 ...
	 <td><img class="doctor-pic" src="{{ url('images/'.$item->Photo)}}" style="height: 60px;wifth: 60px;"></td>
           ...
           <td>{{$item->DepID}}</td>
																		...
																		<td align="center">
																			<a href="{{ url('Emp_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
														 
	             	  
																			<a  href="{{ url('TrashingEmployee/'.$item->id) }}"
