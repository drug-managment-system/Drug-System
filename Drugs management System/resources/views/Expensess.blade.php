				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">ExpensessPage</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Expensess</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">All Expensess List</li>
							</ol>
						</div>
					</div>
					<div class="row">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Expensess List</header>
														<div class="tools">
...
<td>{{$item->Name}}</td>
           ...
           <td>{{$item->Date}}</td>
																		...
																		<td align="center">
																			<a href="{{ url('Exp_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<a href="{{ url('TrashingExpenses/'.$item->id) }}"
