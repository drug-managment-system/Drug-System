					...
					<ul class="nav navbar-nav pull-right">
						...
						<!-- <li class="dropdown language-switch">
							...
							<ul class="dropdown-menu">
								<li>
								<a href='lang' class="nav-link "> <span class="title">
												Pashto</span>
										</a>
								</li>
								<li>
								...
								<li>
									<a class="english"><img src="../assets/img/f 
								<li>
						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item active open">
								<a href="#" class="nav-link nav-toggle"><i class="material-icons">group</i>
									<span class="title">Customers</span><span class="selected"></span>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Customers Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">All Customers List</li>
							</ol>
						</div>
					</div>
					<div class="row">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Customers List</header>
														<div class="tools">
														...
														<div class="row print-container">
															<table
																...
																@foreach($Customer as $item)
																	...
																	<tr class="odd gradeX">
																	<td>{{$item->id}}</td>
	 <td><img class="doctor-pic" src="{{ url('images/'.$item->Photo)}}" style="height: 60px;wifth: 60px;"></td>
                                                                <td>{{$item->Name}}</td>
                                                                ...
                                                                <td>{{$item->Address}}</td>
                                                                 <td>{{$item->Email}}</td>
																		...
																		<td align='center'>
																			<a href="{{ url('Cust_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<a href="{{ url('TrashingCustomer/'.$item->id) }}"
