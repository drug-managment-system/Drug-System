				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Departement</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href='Departement'>Departement</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="{{ url('update-Dep/'.$Departement->id) }}"  method="POST"  >
...
@csrf
        @method('PUT')
                    ...
                    <input type="text" name="DepartementName" value="{{$Departement->DepartementName}}" class="form-control">
										</div>
									</div>
