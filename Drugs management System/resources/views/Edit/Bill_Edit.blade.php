...
<body
	...
	<div class="page-wrapper">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Bill</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href='Bills'>Bills</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
        ...
        <form action="{{ url('update-Bill/'.$Bill->id) }}"  method="POST"  >
								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
                                            ...
                                            <input type="text" name="DrugName" value="{{$Bill->DrugName}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                                           ...
                                           <input type="number" name="Quantity" value="{{$Bill->Quantity}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                           ...
                                           <input type="number" name="Discount" value="{{$Bill->Discount}}" class="form-control">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                            ...
                                            <input type="number" name="Cash" value="{{$Bill->Cash}}" class="form-control">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                           ...
                                           <input type="text" name="Dilevared_By" value="{{$Bill->Dilevared_By}}" class="form-control">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                         ...
                                         <input type="number" name="Stock_ID" value="{{$Bill->Stock_ID}}" class="form-control">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                            ...
                                            <input type="number" name="Customer_ID" value="{{$Bill->Customer_ID}}" class="form-control">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                            ...
                                            <input type="number" name="Loan" value="{{$Bill->Loan}}" class="form-control">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                           ...
                                           <input type="date" name="Date" value="{{$Bill->Date}}" class="form-control">
