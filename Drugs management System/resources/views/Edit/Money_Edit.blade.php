...
<body
	...
	<div class="page-wrapper">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Money</div>
							</div>
        ...
        <form action="{{ url('update-Money/'.$Money->id) }}"  method="POST"  >
...
@csrf
        @method('PUT')
          ...
          <input type="number" name="Total_Blance" value="{{$Money->Total_Blance}}" class="form-control">
                    ...
                    <input type="number" name="Cash" value="{{$Money->Cash}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label for="">Bill_ID  </label>
                   <input type="number" name="Bill_ID" value="{{$Money->Bill_ID}}" class="form-control">
                    ...
                    <input type="number" name="Pre_Blance" value="{{$Money->Pre_Blance}}" class="form-control">
                    ...
                    <input type="number" name="Loan" value="{{$Money->Loan}}" class="form-control">
                 ...
                 <input type="date" name="Date" value="{{$Money->Date}}" class="form-control">
										</div>
									</div>
