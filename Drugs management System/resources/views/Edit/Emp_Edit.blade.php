...
@csrf
    ...
    <input type="text" name="Email" value="{{$Employee->Email}}" class="form-control">
                    ...
                    <input type="text" name="Job" value="{{$Employee->Job}}" class="form-control">
                   ...
                   <input type="date" name="IncomeDate" value="{{$Employee->IncomeDate}}" class="form-control">
                   ...
                   <input type="number" name="DepID" value="{{$Employee->DepID}}" class="form-control">
