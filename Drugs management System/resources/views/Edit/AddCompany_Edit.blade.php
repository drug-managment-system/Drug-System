...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/edit_student.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jan 2020 20:05:53 GMT -->
<head>
	<meta charset="utf-8" />
...
<body
	...
	<div class="page-wrapper">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit AddCompany</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href='AddCompany'>AddCompany</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Edit AddCompany</li>
							</ol>
						</div>
					</div>
					<div class="row">
        ...
        <form action="{{ url('update-AddCompany/'.$AddCompany->id) }}"  method="POST"  >
								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
                                            ...
                                            <label for="" align="rigth">Name  </label>
         <input type="text" name="Name" value="{{$AddCompany->Name}}" align="right" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                     ...
                     <input type="text" name="OwnerName" value="{{$AddCompany->OwnerName}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label for="">Email  </label>
                            <input type="text" name="Email" value="{{$AddCompany->Email}}" class="form-control">
                            ...
                            <input type="text" name="Address" value="{{$AddCompany->Address}}" class="form-control">
                            ...
                            <input type="number" name="Total_Purchase" value="{{$AddCompany->Total_Purchase}}" class="form-control">
                    ...
                    <div class="col-lg-6 p-t-20">
                            ...
                            <input type="number" name="Payment" value="{{$AddCompany->Payment}}" class="form-control">
                            ...
                            <input type="date" name="Date" value="{{$AddCompany->Date}}" class="form-control">
...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/edit_student.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jan 2020 20:05:55 GMT -->
</html>
