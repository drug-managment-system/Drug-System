				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Stock</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href='Stocks'>Stocks</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
...
@csrf
        @method('PUT')
          ...
          <input type="text" name="DrugName" value="{{$Stock->DrugName}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
    ...
    <input type="date" name="EntryDate" value="{{$Stock->EntryDate}}" class="form-control">
                   ...
                   <input type="date" name="ExpireDate" value="{{$Stock->ExpireDate}}" class="form-control">
                    ...
                    <div class="col-lg-6 p-t-20">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
                                           ...
                                           <input type="number" name="Drug_ID" value="{{$Stock->Drug_ID}}" class="form-control">
