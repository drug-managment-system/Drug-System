					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href='Notes'>Notes</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="{{ url('update-Notes/'.$Notes->id) }}"  method="POST"  >
...
@csrf
        @method('PUT')
          ...
          <input type="text" name="Name" value="{{$Notes->Name}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
          ...
          <input type="file" name="Photo" value="{{$Notes->Photo}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
          ...
          <input type="number" name="Amount" value="{{$Notes->Amount}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                    ...
                    <input type="text" name="Detail" value="{{$Notes->Detail}}" class="form-control">
										</div>
									</div>
                    ...
                    <input type="date" name="Date" value="{{$Notes->Date}}" class="form-control">
