...
<body
	...
	<div class="page-wrapper">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Drugs</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href='Drugs'>Bills</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
        ...
        <form action="{{ url('update-Drugs/'.$Drugs->id) }}"  method="POST"  >
...
@csrf
        @method('PUT')
                    ...
                    <input type="text" name="DrugName" value="{{$Drugs->DrugName}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                                        <label  for="">Quantity </label>
                    <input type="number" name="Quantity" value="{{$Drugs->Quantity}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                                        <label for="">Price </label>
                   <input type="number" name="Price" value="{{$Drugs->Price}}" class="form-control">
                    ...
                    <input type="date" name="ExpireDate" value="{{$Drugs->ExpireDate}}" class="form-control">
                    ...
                    <input type="text" name="Category" value="{{$Drugs->Category}}" class="form-control">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <label for="">AddCompany_ID</label>
                  
                   <input type="number" name="AddCompany_ID" value="{{$Drugs->AddCompany_ID}}" class="form-control">
