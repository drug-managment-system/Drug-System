						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item active open">
								<a href="#" class="nav-link nav-toggle"><i class="material-icons">group</i>
									<span class="title">Expensess</span>
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Edit Expensess</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="{{ url('update-Exp/'.$Expenses->id) }}"  method="POST"  >
...
@csrf
        @method('PUT')
          ...
          <input type="text" name="Name" value="{{$Expenses->Name}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
          ...
          <input type="file" name="Photo" value="{{$Expenses->Photo}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
          ...
          <input type="number" name="Amount" value="{{$Expenses->Amount}}" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                    ...
                    <input type="text" name="Detail" value="{{$Expenses->Detail}}" class="form-control">
										</div>
									</div>
