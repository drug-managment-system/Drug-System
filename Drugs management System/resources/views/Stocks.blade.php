		...
		<div class="page-container">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Stocks Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">All Stock List</li>
							</ol>
						</div>
					</div>
					<div class="row">
         ...
         <th>Drug ID</th>
           ...
           <td>{{$item->Drug_ID}}</td>
																		...
																		<td align="center">
																			<a href="{{ url('Stock_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<a href="{{ url('TrashingStock/'.$item->id) }}"
