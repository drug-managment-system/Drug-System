		...
		<div class="page-container">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">AddCompany Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">All AddCompany List</li>
							</ol>
						</div>
					</div>
					<div class="row">
         ...
         <th>Date</th>
           ...
           <td>{{$item->Date}}</td>
																		...
																		<td align='center'>
																			<a href="{{ url('AddCompany_Edit/'.$item->id) }}"
																			class="btn btn-primary btn-sm">
																				<i class="fa fa-pencil"></i>
																			</a>
																			</a>
																			<a href="{{ url('TrashingAddCompany/'.$item->id) }}"
