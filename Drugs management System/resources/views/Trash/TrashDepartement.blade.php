		...
		<div class="page-container">
					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href='TrashCustomer' class="nav-link "> <span class="title">Customers
                                                 Trash</span>
                                                <span class="selected"></span>
										</a>
									</li>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Departements Trash Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Departement Trash</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>Departements Trash List</header>
														<div class="tools">
         ...
         <th>DepartementName</th>
																...
																@foreach($Departement as $item)
                                                                 ...
                                                                 <td class="center">
                                                                        <a href= "{{ url('restoreDepartement/'.$item->id) }}"
                                                                        ...
                                                                        <a href="{{ url('destroyDepartement/'.$item->id) }}"
                                                                        class="btn btn-danger btn-sm" target="iframe_a" >
