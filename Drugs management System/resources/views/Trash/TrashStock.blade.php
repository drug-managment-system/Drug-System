		...
		<div class="page-container">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Stocks Trash Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Stock Trash</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>Stocks Trash List</header>
														<div class="tools">
         ...
         <th>Drug ID</th>
           ...
           <td>{{$item->Drug_ID}}</td>
                                                                 ...
                                                                 <td class="center">
                                                                        <a href= "{{ url('restoreStock/'.$item->id) }}"
                                                                        ...
                                                                        <a href="{{ url('destroyStock/'.$item->id) }}"
                                                                        class="btn btn-danger btn-sm" target="iframe_a" >
