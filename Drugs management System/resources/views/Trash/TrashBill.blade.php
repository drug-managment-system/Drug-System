				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Bills Trash Page</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href='index'>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Bills Trash</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>Bills Trash List</header>
														<div class="tools">
         ...
         <th>Date</th>
          ...
          <td>{{$item->id}}</td>
           ...
           <td>{{$item->Date}}</td>
                                                                 ...
                                                                 <td class="center">
                                                                        <a href= "{{ url('restoreBill/'.$item->id) }}"
                                                                        ...
                                                                        <a href="{{ url('destroyBill/'.$item->id) }}"
                                                                        class="btn btn-danger btn-sm" target="iframe_a" >
