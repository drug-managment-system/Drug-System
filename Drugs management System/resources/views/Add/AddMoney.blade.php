								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="number" name="Total_Blance" >
											<label class="mdl-textfield__label">Total_Blance</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="number" name="Pre_Blance">
											<label class="mdl-textfield__label">Pre_Blance</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="number" name="Bill_ID">
											<label class="mdl-textfield__label">Bill_ID</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
