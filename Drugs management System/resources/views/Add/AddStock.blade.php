					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form class="col-md-12"   action="\store5" method="POST" align="center" >
                 @csrf
								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" name="StockName" >
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="number" name="Drug_ID">
											<label class="mdl-textfield__label">Drug ID </label>
											</div> 
										</div>
                    <div class="col-lg-6 p-t-20">
										<div
                    ...
                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="date" name="EntryDate">
											<label class="mdl-textfield__label">Entry Date</label>
											</div> 
										</div>
                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="date" name="ExpireDate">
