				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Departement</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add Departement</li>
							</ol>
						</div>
					</div>
					<div class="row">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" name="DepartementName">
											<label class="mdl-textfield__label">Departement Name</label>
										</div>
									</div>
