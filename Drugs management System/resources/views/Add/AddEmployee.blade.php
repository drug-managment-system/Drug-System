						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item active open">
								<a href="#" class="nav-link nav-toggle"><i class="material-icons">group</i>
									<span class="title">Employees</span><span class="selected"></span>
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href='Employees'>Employees</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form class="col-md-12"   action="\store1" method="POST" align="center" >
          @csrf
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="FatherName">
											<label class="mdl-textfield__label">Employee Father Name</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">Employee Address</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
                    ...
                    <div class="col-lg-6 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">Employee Salary </label>
											</div> 
										</div>
                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="number" name="DepID">
											<label class="mdl-textfield__label">Departement ID </label>
											</div> 
										</div>
                    <div class="col-lg-6 p-t-20">
										<div
                    ...
                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="date" name="IncomeDate">
											<label class="mdl-textfield__label">Income Date</label>
											</div> 
										</div>
										<div class="col-lg-6 p-t-20">
										<div
