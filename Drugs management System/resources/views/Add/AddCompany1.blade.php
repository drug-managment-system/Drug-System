				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add AddCompany</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add AddCompany</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form class="col-md-12"   action="\store14" method="POST" align="center" >
                 @csrf
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="OwnerName">
                    ...
                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="number" name="Total_Purchase">
											<label class="mdl-textfield__label">Total_Purchase </label>
											</div> 
										</div>
                                                  <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="number" name="Payment">
											<label class="mdl-textfield__label">Payment </label>
											</div> 
										</div>
                    <div class="col-lg-6 p-t-20">
										<div
